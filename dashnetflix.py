...
# Sidebar
st.sidebar.header("Netflix Dashboard")
st.sidebar.markdown("Explore Netflix content trends")

# Main content area
st.title("Netflix Content Analysis")

# Row 1: Content Breakdown (Pie Chart)
st.subheader("Content Breakdown")
fig_type = plt.figure(figsize=(6, 8))
...
# Row 2: Top Genres (Movies and TV Shows)
st.subheader("Top Genres")
col1, col2 = st.columns(2)

# Movie genres
movie_genres = extract_genres(movies['listed_in']).most_common(10)
fig_movie_genres = plt.figure(figsize=(8, 4))
...
fig_tv_genres = plt.figure(figsize=(8, 4))
...
fig_ratings = plt.figure(figsize=(8, 4))
...
# Row 4: Temporal Analysis (Titles per Year)
st.subheader("Titles Added Over Time")
fig_titles_per_year = plt.figure(figsize=(10, 4))
...
# Row 5: Average Movie Duration by Genre
st.subheader("Average Movie Duration by Genre (Top 10)")
fig_duration_by_genre = plt.figure(figsize=(10, 6))
...
plt.tight_layout()
st.pyplot(fig_duration_by_genre)
...
# Row 6: Content Contribution by Country
st.subheader("Content Contribution by Country")
fig_country_contribution = plt.figure(figsize=(8, 8))
...
plt.tight_layout()
st.pyplot(fig_country_contribution)

# Row 7: Top Genres in the US
st.subheader("Top 10 Genres in the US")
us_genres = extract_genres(df[df['country'] == 'United States']['listed_in']).most_common(10)
fig_us_genres = plt.figure(figsize=(8, 4))
...
# Row 8: Top 10 Genres by Top 5 Producing Countries
st.subheader("Top 10 Genres by Top 5 Producing Countries")
fig_genre_by_country = plt.figure(figsize=(12, 6))
